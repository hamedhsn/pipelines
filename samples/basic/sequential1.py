...
from kubernetes.client import V1EnvVar, V1Toleration
...
def gcs_download_op(url):
    ...
    ops.apply(my_volume)
    ops.add_toleration(V1Toleration(
        effect='NoSchedule',
        key='gpu',
        operator='Equal',
        value='run'
    ...
    ops.add_node_selector_constraint(label_name='beta.kubernetes.io/instance-type', value='p2.xlarge')
    ops.container.add_resource_limit(resource_name='nvidia.com/gpu', value=1)
